...
with open('xss_regex.txt','r+') as s1:
		with open('temp_xss_regex.txt','r') as d1:
			for line in s1:
				#print(line)
				if line.strip():
					l1.append(line)
...
c=0
with open('sqli_regex.txt','r+') as s2:
	with open('temp_sqli_regex.txt','r') as d2:
		for line in s2:
			#print(line)
			if line.strip():
				l2.append(line)
...
c=0
with open('dos_regex.txt','r+') as s3:
	with open('temp_dos_regex.txt','r') as d3:
		for line in s3:
			#print(line)
			if line.strip():
				l3.append(line)
	...
	for i, line in enumerate(f):
		...
		for index in l1:							# xss 
			...
			for match in re.finditer(pattern1,line):
				print('----------------------------------------------------------------------------')
				print('Possible Cross site scripting attempt on line ',i,' scripting query')
				#print(i,line)
